...
const removeIngredient = (state, action) => {
    const updatedIngrdnt = { [action.ingredientName]: state.ingredients[action.ingredientName] - 1 }
    const updatedIngrdnts = updateObject(state.ingredients, updatedIngrdnt);
    const updatedSt = {

        ingredients: updatedIngrdnts,
        totalPrice: state.totalPrice + INGREDIENT_PRICES[action.ingredientName],
    }
